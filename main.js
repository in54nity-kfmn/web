...
(function ($) {
    ...
    (function ssInit() {
        ...
        // The following functions are commented out as their corresponding
        // DOM elements don't exist in the current page structure:

        // ssInfoToggle();      // Requires .info-toggle element
        // ssSlickSlider();     // Requires .home-slider element
        // ssPlaceholder();     // Requires form input elements
        // ssFinalCountdown();  // Requires .home-content__clock element (also has outdated 2021 date)
        // ssAjaxChimp();       // Requires #mc-form element
